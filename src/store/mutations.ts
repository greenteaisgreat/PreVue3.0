...
const mutations: Mutations<State> = {
  ...
  [types.ADD_TO_COMPONENT_HTML_LIST]: (state: State, elementName) => {
    ...
    //also adds to routes
    console.log(
      'COMPONENT HTML LIST FUNCTION',
      state.routes[state.activeRoute]
    );
        ...
        if (el.id === id) {
          ...
          if (!oldIndex.length) {
            ...
            if (oldIndex.length === 1) {
              ...
              component.htmlList[oldIndex[0]].children[
                oldIndex[1]
              ].children = newList;
            } else if (oldIndex.length === 3) {
              component.htmlList[oldIndex[0]].children[oldIndex[1]].children[
                oldIndex[2]
              ].children = newList;
            } else if (oldIndex.length === 4) {
              component.htmlList[oldIndex[0]].children[oldIndex[1]].children[
                oldIndex[2]
              ].children[oldIndex[3]].children = newList;
            } else if (oldIndex.length === 5) {
              component.htmlList[oldIndex[0]].children[oldIndex[1]].children[
                oldIndex[2]
              ].children[oldIndex[3]].children[oldIndex[4]].children = newList;
            } else if (oldIndex.length === 6) {
              component.htmlList[oldIndex[0]].children[oldIndex[1]].children[
                oldIndex[2]
              ].children[oldIndex[3]].children[oldIndex[4]].children[
                oldIndex[5]
              ].children = newList;
              ...
              component.htmlList[oldIndex[0]].children[oldIndex[1]].children[
                ...
                oldIndex[5]
              ].children[oldIndex[6]].children = newList;
            }
          }
  ...
  [types.RESTORE_STATE]: (state: State) => {
    //new
    const { routes, activeRoute, arrayOfStates } = state;
